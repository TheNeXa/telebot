...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "Dimas Alif Rayhan",
            BATCH_ACADEMY = "Vulcan",
            GITHUB_REPO_LINK = "https://github.com/TheNeXa"
        )
...
unique_campaign = df['campaign_id'].unique().astype(object)
    ...
    if selected_campaign_id in unique_campaign:
        ...
        with open('template_text/summary.txt', mode='r', encoding='utf-8') as f:
            ...
            summary = temp.substitute(
                ...
                TOTAL_CONVERSION = f"{total_conversion:,d}",
                CPC = f"${cpc:.1f}"
            )
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        min_conv_age = df_plot.approved_conversion.idxmin()
        max_conv_age = df_plot.approved_conversion.idxmax()
        ...
        plot_info = list(zip(
            ...
            [max_spent_age, max_conv_age, max_cpc_age],
            [min_spent_age, min_conv_age, min_cpc_age]
        ))
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute(EMOJI = emoji.emojize(':face_with_spiral_eyes:'))
